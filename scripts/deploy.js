async function main() {
  ...
  const MyToken = await hre.ethers.getContractFactory("LucasNFT");
  ...
  await nft.safeMint(await signer0.getAddress(), "ipfs://Qmc18ojAsY93x1reqSVgARmF54L8hHgGXRNcXNZUE6Dw7x");
